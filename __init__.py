...
def register():
    ...
    bpy.utils.register_class(complete_bones_operator.OBJECT_OT_fix_palm_weights)
...
def unregister():
    ...
    bpy.utils.unregister_class(complete_bones_operator.OBJECT_OT_fix_palm_weights)
